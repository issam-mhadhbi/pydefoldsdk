...
from pydefoldsdk.script import lua_source_ddf_pb2 as script_dot_lua__source__ddf__pb2
from pydefoldsdk.gameobject import properties_ddf_pb2 as gameobject_dot_properties__ddf__pb2
